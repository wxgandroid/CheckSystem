...
public class PlayerManager {
    ...
    private OnErrorListener.OnCompleteListener onCompleteListener = new OnErrorListener.OnCompleteListener() {
        @Override
        public void onComplete() {
        }
    };

    private OnErrorListener.OnInfoListener onInfoListener = new OnErrorListener.OnInfoListener() {
        @Override
        public void onInfo(int what, int extra) {

        }
    };
    private OnErrorListener.OnControlPanelVisibilityChangeListener onControlPanelVisibilityChangeListener = new OnErrorListener.OnControlPanelVisibilityChangeListener() {
        @Override
    ...
    public PlayerManager(final Activity activity,int source_id) {
        try {
        ...
        videoView = (IjkVideoView) activity.findViewById(source_id);
...
//            $.id(R.id.app_video_loading).visible();
    ...
    public PlayerManager onComplete(OnErrorListener.OnCompleteListener onCompleteListener) {
        this.onCompleteListener = onCompleteListener;
        return this;
    }

    public PlayerManager onInfo(OnErrorListener.OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public PlayerManager onControlPanelVisibilityChange(OnErrorListener.OnControlPanelVisibilityChangeListener listener) {
